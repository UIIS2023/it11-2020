...
public class DlgHexagon extends JDialog {
	...
	public DlgHexagon() {
		...
		getContentPane().setLayout(new BorderLayout(0, 0));
		{
			...
			{
				lnlNewRadius3 = new JLabel("Radius");
				lnlNewRadius3.setHorizontalAlignment(SwingConstants.CENTER);
			}
			{
				txtnewRadius3 = new JTextField();
				txtnewRadius3.setColumns(10);
			}
			{
				...
				gl_pnlCenter.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_pnlCenter.createSequentialGroup()
						.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(gl_pnlCenter.createSequentialGroup()
								.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
									.addComponent(lnlNewRadius3, GroupLayout.PREFERRED_SIZE, 147, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_pnlCenter.createSequentialGroup()
										.addGap(10)
										.addComponent(btnColor, GroupLayout.PREFERRED_SIZE, 98, GroupLayout.PREFERRED_SIZE)))
								.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
									.addComponent(txtnewRadius3, GroupLayout.PREFERRED_SIZE, 147, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_pnlCenter.createSequentialGroup()
										.addGap(10)
			...
			gl_pnlCenter.setVerticalGroup(
				gl_pnlCenter.createParallelGroup(Alignment.LEADING)
					.addGroup(gl_pnlCenter.createSequentialGroup()
						...
						.addGroup(gl_pnlCenter.createParallelGroup(Alignment.LEADING)
							.addComponent(lnlNewRadius3, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
							.addComponent(txtnewRadius3, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE))
				...
				btnOk.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent arg0) {
						try {
							...
							int newRadius3 = Integer.parseInt(txtnewRadius3.getText());

							if(newX < 0 || newY < 0 || newRadius3 < 1) {
							...
							hexagonAdapter = new HexagonAdapter(new Point(newX, newY), newRadius3, false, edgeColor, innerColor);
							dispose();
						} catch (Exception ex) {
							JOptionPane.showMessageDialog(null, "You have entered incorrect informations!", "ERROR!", JOptionPane.ERROR_MESSAGE);
						}
	...
	public void setHexagonAdapter(HexagonAdapter hexagonAdapter) {
		...
		txtnewRadius3.setText("" + hexagonAdapter.getHexagon().getR());
		
		innerColor = hexagonAdapter.getInnerColor();
		edgeColor= hexagonAdapter.getColor();
	}
	
	
	
//	public void setHexagon(Hexagon shape) {
//		txtX.setText("" + shape.getX());
//		txtY.setText("" + shape.getY());
//		txtnewRadius3.setText("" + shape.getR());
//		
//		innerColor = shape.getAreaColor();
//		edgeColor = shape.getBorderColor();
//		
//	}
